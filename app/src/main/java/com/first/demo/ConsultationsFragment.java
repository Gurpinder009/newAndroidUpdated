 ...
 * Use the {@link ConsultationsFragment#newInstance} factory method to
...
public class ConsultationsFragment extends Fragment {
     ...
     * @return A new instance of fragment ConsultationsFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String [] consultations = ConsultationDbHelper.queryAll(db);
        list = view.findViewById(R.id.consultationsList);
        assert getActivity() != null;
        ArrayAdapter<String> arr = new ArrayAdapter<>(getActivity().getApplicationContext(), com.google.android.material.R.layout.support_simple_spinner_dropdown_item, consultations);
        list.setAdapter(arr);
    }
}