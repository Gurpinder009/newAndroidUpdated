...
public class Patient {
    ...
    public Patient(int id, String name, String emailAddress, String phoneNumber, Date dob, String address, String gender, String emergencyContact, String bloodType, String height, String weight, String allergies, int isActive){
        this.id = id;
        this.name = name;
    ...
    public static  Patient fromCursor(Cursor cursor){
        ...
        patient.setName(cursor.getString(cursor.getColumnIndexOrThrow("first_name")));
        ...
        patient.setDob(Date.valueOf(cursor.getString(cursor.getColumnIndexOrThrow("dob"))));
