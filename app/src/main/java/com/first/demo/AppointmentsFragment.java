...
public class AppointmentsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String [] appointments = AppointmentDbHelper.queryAll(db);
        list = view.findViewById(R.id.appointmentsList);
        assert getActivity() != null;
        ArrayAdapter<String> arr = new ArrayAdapter<>(getActivity().getApplicationContext(), com.google.android.material.R.layout.support_simple_spinner_dropdown_item, appointments);
        list.setAdapter(arr);
    }
}